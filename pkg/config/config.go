...
type GatewayConfig struct {
	...
	SysMessagePrefix string                      `json:"sys_message_prefix" env:"PICOCLAW_GATEWAY_SYS_MESSAGE_PREFIX"`
	AutoFinalPrefix  string                      `json:"auto_final_prefix" env:"PICOCLAW_GATEWAY_AUTO_FINAL_PREFIX"`
...
func DefaultConfig() *Config {
	return &Config{
		...
		Gateway: GatewayConfig{
			Host:             "0.0.0.0",
			Port:             18790,
			SysMessagePrefix: "[SYS]",
			AutoFinalPrefix:  "[AUTO]",
